...
class BasicTriplessIterator:
    ...
    def next(self):
        ...
        for i in range(int(self.cate_size)):
            ...
            src_idx1=np.random.randint(len(self.visited[self.d_dict[idx[0]]]))
            src_idx2=np.random.randint(len(self.visited[self.d_dict[idx[0]]]))
            tar_idx=np.random.randint(len(self.visited[self.d_dict[idx[1]]]))
            img_src1 = np.float32(255.*resize(np.float32(imread(fn(TRAIN_DIR+ self.d_dict[idx[0]] + '/' + self.visited[self.d_dict[idx[0]]][src_idx1])))/255.,(224,224,3),anti_aliasing=True))
            img_src2 = np.float32(255.*resize(np.float32(imread(fn(TRAIN_DIR+ self.d_dict[idx[0]] + '/' + self.visited[self.d_dict[idx[0]]][src_idx2])))/255.,(224,224,3),anti_aliasing=True))
            img_tar= np.float32(255.*resize(np.float32(imread(fn(TRAIN_DIR+ self.d_dict[idx[1]] + '/' + self.visited[self.d_dict[idx[1]]][tar_idx])))/255.,(224,224,3),anti_aliasing=True))
...
class BasicTriplessIteratorTest:
    ...
    def next(self):
        ...
        for i in range(int(self.cate_size)):
            ...
            img_src1 = np.float32(255.*resize(np.float32(imread(fn(TEST_DIR + '/' + self.td_dict[src_name][src_idx1])))/255.,(224,224,3),anti_aliasing=True))
            img_src2 = np.float32(255.*resize(np.float32(imread(fn(TEST_DIR + '/' + self.td_dict[src_name][src_idx2])))/255.,(224,224,3),anti_aliasing=True))
            img_tar = np.float32(255.*resize(np.float32(imread(fn(TEST_DIR + '/' + self.td_dict[tar_name][tar_idx])))/255.,(224,224,3),anti_aliasing=True))
